...
https://github.com/jakasco/htmlFetcher.git
...
drop table if exists cssTiedostot4;
CREATE TABLE cssTiedostot4
(
  CSS_Id int NOT NULL AUTO_INCREMENT,
  User_Id INT,
  nimi VARCHAR(100),
...
ALTER TABLE `cssTiedostot4` MODIFY `CSS_Tiedosto` LONGTEXT;
ALTER TABLE `cssTiedostot4` MODIFY `Muokattu_Tiedosto` LONGTEXT;
...
drop table if exists userSourceCode;
CREATE TABLE userSourceCode
(
  User_Id INT,
  Source_Code TEXT,
  CSS_Files INT
...
ALTER TABLE `userSourceCode` MODIFY `Source_Code` LONGTEXT;
